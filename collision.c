...
int main(int argc, char *argv[])
{
	...
	for(j = 0; j < 10000; j++)
	{
		...
		{printf("Initial String is %s and randomly generated string is %s\n",mess,rand_str);
		...
		printf("\nHash value for randomly generated  string in hexadecimal is ");
		for (int i = 0; i < 3; i++)
		{
		...
		if(match >= 0)
		{
		printf("Repository String is %s and randomly generated string is %s\n",repo_msg[match],rand_str);
